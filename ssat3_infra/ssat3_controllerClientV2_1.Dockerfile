...
#
LABEL com.ssat3.version="2.0.1-test"
LABEL com.ssat3.name="Controller-tester_v2.1"
LABEL com.ssat3.description="QTemp Controller for IOT climate control - Controller pub-sub tester"
LABEL com.ssat3.build-date="2021-18-04T32:00:30.00Z"
#
...
COPY controllerClientv2_1.py /opt/qtemp
#  Copy python modules
